...
urlpatterns = [
    ...
    path('borrow/list', views.borrow.list_api),
    path('borrow/create', views.borrow.create),
    path('borrow/update', views.borrow.update),
    path('borrow/delete', views.borrow.delete),
