...
// 路由权限白名单
const allowList = ['admin-login', 'portal', 'list', 'detail', 'searchContentView', 'mineInfosView', 'bookContentView', 'bookInfosView', 'header', 'footer', 'contentRight', 'contentLeft', '403', '404']
// 前台登录地址
