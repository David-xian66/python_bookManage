...
// 路由权限白名单
const allowList = ['admin-login', 'portal', 'list', 'detail', 'userInfoEditView', 'orderView', 'collectBookView', 'searchContentView', 'mineInfosView', 'bookContentView', 'bookInfosView', 'header', 'footer', 'contentRight', 'contentLeft', '403', '404']
// 前台登录地址
